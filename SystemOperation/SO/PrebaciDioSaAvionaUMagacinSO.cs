...
{
    public class PrebaciDioSaAvionaUMagacinSO : SystemOperationBase
    {
        private RotablePartsLog rotablePartsLog;
        private static Object _lock = new Object();
        public PrebaciDioSaAvionaUMagacinSO(RotablePartsLog rotablePartsLog)
        {
        ...
        protected override void Execute()
        {
            ...
            {
                throw new SystemOperationException("Sistem ne može da izvrši prebacivanje dijela sa aviona u magacin!");
            }
        }
    }
}
